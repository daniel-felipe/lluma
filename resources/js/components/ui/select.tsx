...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex w-full items-center justify-between gap-2 rounded-[8px] border border-input bg-background px-[14px] py-3 text-[15px] whitespace-nowrap outline-none transition-[color,border-color,outline]",
